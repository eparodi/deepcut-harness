...
// It is a leaf package — it imports only net/http and log/slog, never
// dashboard — so page subpackages can import it without creating an
// import cycle (dashboard → pages/<name> → page).
package page
